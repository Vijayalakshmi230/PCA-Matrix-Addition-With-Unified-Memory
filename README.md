...
4. Declare the main function and set up the device & data size of matrix , perform memory allocation on host memory & initialize the data at host side then add matrix at host side for result checks followed by 
   invoking kernel at host side. Check the kernel error, and check device for results.Finally free the device global memory and reset device.
...
![image](https://github.com/Vijayalakshmi230/PCA-Matrix-Addition-With-Unified-Memory/assets/127175503/cd953640-ea0e-4fb2-b490-e0f637dde8e6)

Without Memset

![image](https://github.com/Vijayalakshmi230/PCA-Matrix-Addition-With-Unified-Memory/assets/127175503/1d265a1c-baee-4757-9a08-560774ca0f46)
